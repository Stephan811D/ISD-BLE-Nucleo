...
{
  /* Temperature */
  CUSTOM_STM_TEMPERATURE_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_TEMPERATURE_NOTIFY_DISABLED_EVT,
  /* Humidity */
  CUSTOM_STM_HUMIDITY_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_HUMIDITY_NOTIFY_DISABLED_EVT,
